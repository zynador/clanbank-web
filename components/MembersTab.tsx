    ...
    <div style={{ maxWidth: '600px', margin: '0 auto', padding: '0 0 2rem' }}>
      ...
      {!loading && filtered.map(m => {
        ...
        return (
          <div key={key} style={{
            ...
            borderRadius: 'var(--border-radius-lg)', marginBottom: '8px', opacity: isLeft ? 0.65 : 1, overflow: 'hidden',
          }}>
            {/* Header */}
                ...
                <div style={{ borderTop: '0.5px solid var(--color-border-tertiary)', padding: '12px' }}>
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                    ...
                    <div style={{ display: 'flex', gap: '8px', marginTop: '4px' }}>
                      <button onClick={() => handleUpdateMember(m)} disabled={savingEdit} style={{
                  ...
                  {isLeft ? (
                    ...
                    <>
                      ...
                      {m.profile_id && isAdminOrOfficer && (
                        <button onClick={() => setExemptionTarget({ id: m.profile_id!, ingameName: m.ingame_name })}
                          style={actionBtn('var(--color-text-warning)')}>
      ...
      {showAddForm ? (
        <div style={{
          ...
          <div style={{ display: 'flex', gap: '8px' }}>
            <button onClick={handleAddMember} disabled={adding || !newName.trim()} style={{
              flex: 1, padding: '8px', fontSize: '13px', cursor: 'pointer',
              borderRadius: 'var(--border-radius-md)', border: '0.5px solid var(--color-border-secondary)',
              background: 'var(--color-background-success)', color: 'var(--color-text-success)',
            }}>
