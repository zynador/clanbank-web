...
> **Letzte Aktualisierung:** 13.04.2026 | Fahrplan V40
...
│   ├── login/
│   │   └── page.tsx              ← Login-Seite mit TGM Consigliere Banner + Signatur (V40)
│   ├── register/
...
### `HomeTab.tsx` (V40)
- **statusOk:** `'TGM Consigliere: Du bist auf dem Laufenden'` (war "Clanbank: ...")
...
## 6. Demo-System (Idee 7 — ERLEDIGT V39)

1. `/demo` → Rollenwahl → POST `/api/demo/login` → Redirect `/dashboard`
2. isDemo=true → Demo-Banner (teal), Tour ausgeblendet, AdminPanel Einladungscode versteckt
3. Demo-Clan-UUID: `00000000-0000-0000-0000-000000000002`
